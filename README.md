...
### Android
1. **For Smartphones**:
   - 下载**PhoneIMU.apk**从[链接](https://cloud.tsinghua.edu.cn/f/6133d04747394d298bb5/?dl=1).
   - 在安卓手机上安装这个app

2. **For Smartwatches** (if applicable):
   - 下载**WatchIMU.apk**从[链接](https://cloud.tsinghua.edu.cn/f/69fd969c4ab24b5da0dd/?dl=1).
   - 在智能手表上安装这个app。
### Huawei
### Apple
### Livedemo
